...
TIPS = {
    ...
    "역각25":                        (2.0, -1, "9시 2팁 (좌)"),
    "역각55":                        (2.0, -1, "9시 2팁 (좌)"),
    # ★ 원쿠션걸어치기 — 사용자 2026-08-15: '역회전 없어요. 전부 제각 순회전입니다.
    #   무회전도 아니고 순회전 2시30분입니다. 0808과 반대로 친거잖아요.
    #   0808은 위에서 아래로, 이것은 아래에서 위로. 당연히 당점은 반대이지만
    #   돌아가는 방향은 모두 제각으로 돌아가는거잖아요.'
    #   → 실측이 그대로 맞다. 0808·2순위는 **반시계**(9시30분이 순),
    #     원쿠션걸어치기는 **시계**(2시30분이 순). 셋 다 e·sIn = +1 = 순이다.
    #   한때 이 영상을 '샷마다 당점이 다르다' 며 뺐는데, 사용자가 전부 2시30분이라고 확인했다.
    "원쿠션걸어치기":                 (3.0, +1, "2시30분 3팁 (우)"),
